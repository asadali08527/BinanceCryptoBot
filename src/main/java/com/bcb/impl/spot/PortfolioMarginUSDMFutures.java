...
public class PortfolioMarginUSDMFutures {
    private final String baseUrl;
    private final RequestHandler requestHandler;
    private final boolean showLimitUsage;

    public PortfolioMarginUSDMFutures(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage, ProxyAuth proxy) {
        this.baseUrl = baseUrl;
        this.requestHandler = new RequestHandler(apiKey, new HmacSignatureGenerator(secretKey), proxy);
        this.showLimitUsage = showLimitUsage;
    }

    public PortfolioMarginUSDMFutures(String baseUrl, String apiKey, SignatureGenerator signatureGenerator, boolean showLimitUsage, ProxyAuth proxy) {
        this.baseUrl = baseUrl;
    ...
    private final String FUTURES_TRANSFER_PAPI = "/papi/v1/um/futures/transfer";

    private final String FUTURE_ALL_ORDERS = "/fapi/v1/allOrders";
    private final String FUTURE_ALL_ORDERS_PAPI = "/papi/v1/um/allOrders";

    private final String FUTURE_OPEN_POSITION = "/fapi/v2/positionRisk";
    private final String FUTURE_OPEN_POSITION_PAPI = "/papi/v1/um/positionRisk";

    private final String FUTURE_CREATE_POSITION = "/fapi/v1/order";
    private final String FUTURE_CREATE_POSITION_PAPI = "/papi/v1/um/order";

    private final String FUTURE_OPEN_ORDERS = "/fapi/v1/openOrders";
    //private final String FUTURE_OPEN_ORDERS_PAPI = "/papi/v1/um/openOrders";
    private final String FUTURE_OPEN_ORDERS_PAPI = "/papi/v1/um/conditional/allOrders";

    private final String FUTURE_OPEN_ORDER = "/fapi/v1/openOrder";
    private final String FUTURE_OPEN_ORDER_PAPI = "/papi/v1/um/openOrder";
    ...
    private final String FUTURE_DELETE_ORDER_PAPI = "/papi/v1/um/order";
    ...
    private final String FUTURE_LIMIT_ORDER = "/papi/v1/um/conditional/order";
	...
	public String getAllCoinMFuturesOpenPosition(Map<String, Object> parameters, boolean isPapi) {
		 String endpoint = isPapi ? "/papi/v1/cm/positionRisk" : FUTURE_OPEN_POSITION;
	     return requestHandler.sendSignedRequest(baseUrl, endpoint, parameters, HttpMethod.GET, showLimitUsage);
	}
}
